  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col gap-6 px-4 py-4 md:px-6 md:py-6 lg:flex-row lg:gap-8">
        <aside className="top-6 h-fit shrink-0 rounded-[28px] border border-black/5 bg-white/70 p-4 shadow-panel backdrop-blur lg:sticky lg:w-72">
          <div className="mb-6">
                ...
                <Link
                  ...
                  className={`rounded-2xl px-4 py-3 text-sm font-medium transition ${
                    isActive
                      ...
                      : "bg-canvas/80 text-ink/75 hover:bg-sand"
                  }`}
                >
                  {item.label}
                </Link>
